...
static void InitDefaultsscc_info_RpcHeader_rpc_5fheader_2eproto() {
  ...
  {
    void* ptr = &::diamondlover::_RpcHeader_default_instance_;
    new (ptr) ::diamondlover::RpcHeader();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::diamondlover::RpcHeader::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_rpc_5fheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::diamondlover::RpcHeader, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::diamondlover::RpcHeader, service_name_),
  PROTOBUF_FIELD_OFFSET(::diamondlover::RpcHeader, method_name_),
  PROTOBUF_FIELD_OFFSET(::diamondlover::RpcHeader, args_size_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::diamondlover::RpcHeader)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::diamondlover::_RpcHeader_default_instance_),
};

const char descriptor_table_protodef_rpc_5fheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\020rpc_header.proto\022\014diamondlover\"I\n\tRpcH"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_rpc_5fheader_2eproto = {
  &descriptor_table_rpc_5fheader_2eproto_initialized, descriptor_table_protodef_rpc_5fheader_2eproto, "rpc_header.proto", 115,
...
RpcHeader::RpcHeader()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:diamondlover.RpcHeader)
}
RpcHeader::RpcHeader(const RpcHeader& from)
  ...
  // @@protoc_insertion_point(copy_constructor:diamondlover.RpcHeader)
}
...
RpcHeader::~RpcHeader() {
  // @@protoc_insertion_point(destructor:diamondlover.RpcHeader)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:diamondlover.RpcHeader)
...
::PROTOBUF_NAMESPACE_ID::uint8* RpcHeader::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:diamondlover.RpcHeader)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:diamondlover.RpcHeader)
  return target;
}

size_t RpcHeader::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:diamondlover.RpcHeader)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:diamondlover.RpcHeader)
  GOOGLE_DCHECK_NE(&from, this);
  const RpcHeader* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RpcHeader>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:diamondlover.RpcHeader)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:diamondlover.RpcHeader)
    MergeFrom(*source);
  }
}

void RpcHeader::MergeFrom(const RpcHeader& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:diamondlover.RpcHeader)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:diamondlover.RpcHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:diamondlover.RpcHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::diamondlover::RpcHeader* Arena::CreateMaybeMessage< ::diamondlover::RpcHeader >(Arena* arena) {
  return Arena::CreateInternal< ::diamondlover::RpcHeader >(arena);
}
